                ...
                <div>
                    ...
                    <div className="row d-flex justify-content-center" >
                        <div className="btn-group" role="group" aria-label="Basic example">
                            <button type="button" className="btn btn-lg btn-outline-info rounded-0" style={{height:80,width:80}} onClick={() => this.handleOpenDoor(1)}>1</button>
                            <button type="button" className="btn btn-lg btn-outline-info rounded-0" style={{height:80,width:80}} onClick={() => this.handleOpenDoor(2)}>2</button>
                            <button type="button" className="btn btn-lg btn-outline-info rounded-0" style={{height:80,width:80}} onClick={() => this.handleOpenDoor(3)}>3</button>
                        </div>
                    </div>
                    <div className="row d-flex justify-content-center">
                        <div className="btn-group" role="group" aria-label="Basic example">
                            <button type="button" className="btn btn-lg btn-outline-info rounded-0" style={{height:80,width:80}} onClick={() => this.handleOpenDoor(4)}>4</button>
                            <button type="button" className="btn btn-lg btn-outline-info rounded-0" style={{height:80,width:80}} onClick={() => this.handleOpenDoor(5)}>5</button>
                            <button type="button" className="btn btn-lg btn-outline-info rounded-0" style={{height:80,width:80}} onClick={() => this.handleOpenDoor(6)}>6</button>
                        </div>
                    </div>
                    <div className="row d-flex justify-content-center" >
                        <div className="btn-group" role="group" aria-label="Basic example">
                            <button type="button" className="btn btn-lg btn-outline-info rounded-0" style={{height:80,width:80}} onClick={() => this.handleOpenDoor(7)}>7</button>
                            <button type="button" className="btn btn-lg btn-outline-info rounded-0" style={{height:80,width:80}} onClick={() => this.handleOpenDoor(8)}>8</button>
                            <button type="button" className="btn btn-lg btn-outline-info rounded-0" style={{height:80,width:80}} onClick={() => this.handleOpenDoor(9)}>9</button>
                        </div>
                    </div>
